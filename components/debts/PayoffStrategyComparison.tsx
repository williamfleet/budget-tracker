...
export default function PayoffStrategyComparison({
  ...
  if (debts.length === 0) {
    return (
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6 text-center text-gray-500 dark:text-gray-400 dark:text-gray-500">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="border-2 border-gray-200 dark:border-gray-700 rounded-lg p-4">
            ...
            {comparison.betterStrategy === 'snowball' && (
              <div className="mt-3 bg-green-50 dark:bg-green-900/20 border border-green-200 rounded p-2 text-xs text-green-800">
              ...
              <div key={debt.debt_id} className="border-l-4 border-indigo-500 pl-4">
                <div className="flex justify-between items-start mb-1">
                  <div>
                    ...
                    <span className="text-xs text-gray-500 dark:text-gray-400 dark:text-gray-500 ml-2">
